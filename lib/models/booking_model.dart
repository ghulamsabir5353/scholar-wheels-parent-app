...
class BookingModel {
    ...
    factory BookingModel.fromJson(Map<String, dynamic> json) => BookingModel(
        ...
        childIds: json["childIds"] == null ? [] : List<String>.from(json["childIds"]!.map((x) => x)),
        ...
        v: json["__v"],
        transportOwner: json["transportOwner"] == null ? null : TransportOwner.fromJson(json["transportOwner"]),
...
class Child {
    ...
    String? get schoolDescription {
        ...
        if (school is Map<String, dynamic>) {
            try {
                final locationData = LocationData.fromJson(school as Map<String, dynamic>);
    ...
    String? get pickUpAddressDescription {
        ...
        if (pickUpAddress is Map<String, dynamic>) {
            try {
                final locationData = LocationData.fromJson(pickUpAddress as Map<String, dynamic>);
                return locationData.description;
            } catch (e) {
                return null;
            }
    ...
    String? get dropOffAddressDescription {
        ...
        if (dropOffAddress is Map<String, dynamic>) {
            try {
                final locationData = LocationData.fromJson(dropOffAddress as Map<String, dynamic>);
                return locationData.description;
            } catch (e) {
                return null;
            }
...
class ParentUser {
    ...
    ParentUser copyWith({
        ...
        ParentUser(
            ...
            profileImage: profileImage ?? this.profileImage,
            profileImagePresignedUrl: profileImagePresignedUrl ?? this.profileImagePresignedUrl,
        );
...
class TransportOwner {
    ...
    factory TransportOwner.fromJson(Map<String, dynamic> json) => TransportOwner(
        ...
        postalCode: json["postalCode"],
        city: json["city"],
        businessDocuments: json["businessDocuments"] == null ? [] : List<BusinessDocument>.from(json["businessDocuments"]!.map((x) => BusinessDocument.fromJson(x))),
        createdAt: json["createdAt"] == null ? null : DateTime.parse(json["createdAt"]),
        updatedAt: json["updatedAt"] == null ? null : DateTime.parse(json["updatedAt"]),
        v: json["__v"],
        isDeleted: json["isDeleted"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "postalCode": postalCode,
        "city": city,
        "businessDocuments": businessDocuments == null ? [] : List<dynamic>.from(businessDocuments!.map((x) => x.toJson())),
        "createdAt": createdAt?.toIso8601String(),
        "updatedAt": updatedAt?.toIso8601String(),
        "__v": v,
        "isDeleted": isDeleted,
